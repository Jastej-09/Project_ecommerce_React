...
const login = () => {
    ...
    const navigate = useNavigate();
     ...
     const handleSubmit = (e) => {
        ...
        axios.post("https://project-ecommerce-react.onrender.com/users/register", formData)
            .then((res) => {
                console.log(res);
                navigate("/store")
            })
      ...
      <div className="body">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input 
                    ...
                    <button className="secondary-btn" onClick={() => navigate('/users')}>Already a User?</button>
